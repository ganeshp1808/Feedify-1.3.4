...
<body>
	...
	<section id='secondsection'>
		<div id="form">
			...
			<h4 align='center'>Select name and teacher id of the respective teacher you want to delete data.</h4>
			<h3 align='center' style="color:red">This will clear data for particular faculty but faculty will not be deleted.</h3>
			<br><br>
...
$delete_data="delete from $itis where teacher_id='$t_id'";
