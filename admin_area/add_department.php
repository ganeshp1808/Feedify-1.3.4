...
echo"<title>Add Department-$college</title>";
	...
	<section id='secondsection'>
		<div id="form">
			...
			<form align='center' method="post">
				<input class="form-control" type="text" name="dept_id" placeholder="Department ID" required="required" /><br>
				<input class="form-control" type="text" name="dept_name" placeholder="Department Name" required="required" /><br>
				<input class="form-control" type="text" name="dept_email" placeholder="Department Email" required="required" /><br><br>
				<button  type="submit" class="btn btn-primary " name="add_dept">Add Department</button>
			</form>
		</div>
	</section>
</div>
...
if(isset($_POST['add_dept'])){
	...
	$add_dept = "insert into departments (dept_id,dept_name,dept_email) values ('$dept_id','$dept_name','$dept_email')";
