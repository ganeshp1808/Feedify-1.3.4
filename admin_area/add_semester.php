...
echo"<title>Add Semster-$college</title>";
...
<body>
	...
	<section id='secondsection'>
		<div id="form">
			...
			<h4 align='center'>This is for adding those semester which you forgot while adding while Getting Started.</h4>
			<br><br>
			<form method="post" align='center'>
				
				<select class='form-control' type='number' name='sem_name' required>
				...
				<button align='center' type="submit" class="btn btn-primary " name="add_sem">Add Semester</button>
			</form>
		</div>
	</section>
	<?php } else if($type=='School'){?>
	<section id='secondsection'>
		<div id="form">
			<h1 align='center'>Add Class</h1>
			<h4 align='center'>This is for adding those classes which you forgot while adding while Getting Started.</h4>
			<br><br>
			<form method="post" align='center'>
				<select class='form-control' type='number' name='sem_name' required>
				<option value="">Select Semester</option>
				...
				<button align='center' type="submit" class="btn btn-primary " name="add_sem">Add Class</button>
			</form>
		</div>
	</section>
	<?php } ?>
...
if(isset($_POST['add_sem'])){
	...
	$add_dept = "insert into semester (sem_name) values ('$sem_name')";
