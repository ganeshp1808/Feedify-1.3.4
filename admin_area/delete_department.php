...
<body>
	...
	<section id='secondsection'>
		<div align='center' class='container'>
			<form align='center' method="post">
					<tr><td><h2 id='pip' >Select Department you want to Delete.</h2></td><br>
							<td><h2>Delete Department </h2></td><br>
							<tr><td ><select class="form-control" name="teacher_department" required>
						...
						<br><br>
						<tr>
							<input type="submit" class='btn btn-primary' name='enter_entries' value='Delete' />
						</tr>
				</form>
		</div>
	</section>
	<?php
			if(isset($_POST['enter_entries'])){
				$del_dep=$_POST['teacher_department'];
				$sel_deldep="delete from departments where dept_name='$del_dep'";
				$run_del=mysqli_query($con,$sel_deldep);
				if($run_del){
