...
<body>
	...
	<section id='secondsection'>
		<div align='center' class='container'>
			<form align='center' method="post">
					<tr><td><h2 id='pip' >Select Semester you want to Delete.</h2></td><br>
							<td><h2>Delete Semester </h2></td><br>
							<tr><td ><select class="form-control" name="teacher_semester" required>
	...
	<?php
			if(isset($_POST['enter_entries'])){
				$del_dep=$_POST['teacher_semester'];
				$sel_deldep="delete from semester where sem_name='$del_dep'";
