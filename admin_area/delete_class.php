...
<body>
	...
	<section id='secondsection'>
		<div id="form">
			<h1 align='center'>Delete Class</h1>
			<h4 align='center'>Select department and semester for the class to be deleted.</h4>
			<h3 align='center' style="color:red">Choose options carefully.</h3>
			<br><br>
			<form align='center' method="post">
				<select  class="form-control" type="text" name="dep" required>
				<option value="">Select Teacher</option>
					...
					<select  class="form-control" type="text" name="sem" required>
...
if(isset($_POST['add_sem'])){
	$teach_name=$_POST['dep'];
	$t_id=$_POST['sem'];
$delete_data="delete from students where department='$teach_name' and class='$t_id'";
...
if($run_delte){
	...
	echo"<script>
					...
					p1.textContent='Wrong Department';
					p2.textContent='Wrong Semester';
				</script>";
}
}
}
