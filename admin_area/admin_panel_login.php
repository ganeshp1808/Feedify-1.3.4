...
<?php
	...
	echo"<title>Admin Login Panel-$college</title>";
?>
...
<a style='color:black;margin-left:30px;margin-top:30px;width:200px;' class='btn' href='../college_page?name=<?php echo $college ?>'><b>Go To Main Page</b></a>
	...
	<br><br>
		...
		<form align='center' method="post">
			<input class="form-control" type="text" name="admin_panel_username" placeholder="Username" required="required" />
			<span id="user"></span>
			<br><br>
			<input class="form-control" type="password" name="admin_panel_password" placeholder="Password" required="required" />
			<span id="pass"></span>
			<br><br>
...
if(isset($_POST['login'])){
	$user_name = $_POST['admin_panel_username'];
	$user_pass = $_POST['admin_panel_password'];
	$sel_teacher = "select * from institutions where admin_panel_username='$user_name' AND admin_panel_password='$user_pass' and name='$college' and college_id='$college_id'";
	$run_teacher = mysqli_query($con, $sel_teacher); 
